...
export default class StatisticsRevenue extends Component {
  ...
  callApi = async () => {
    ...
    let data = await axiosInstance("Statistics", "POST", {
      option: option,
      month: month,
      year: year,
    }).then((res) => {
          ...
          <div className="content">
            ...
            <Row style={{ background: "#fafafa", padding: "10px" }}>
              ...
              <Col offset={1}>
                <Button
                  type="primary"
                  onClick={this.handleClickStatisticsButton.bind(this)}
                >
                  Thống kê
                </Button>
              </Col>
              <Col offset={1}>
                <Button
                  ...
                  type="primary"
                  onClick={this.handleViewDetailStatistics.bind(this)}
                >
                  Xem Chi tiết
                </Button>
              </Col>
