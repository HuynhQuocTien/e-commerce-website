...
export default class StatisticsProduct extends Component {
  ...
  callApi = async () => {
    ...
    let data = await axiosInstance("Statistics/ProductStatistics", "POST", {
      status: status,
    }).then((res) => {
      return res.data;
    });
  ...
  callApiOrder = async () => {
    let data = await axiosInstance(
      "Statistics/StatusOrderStatistics",
      "GET"
    ).then((res) => {
      return res.data;
    });
  ...
  async handleChange(e) {
    this.setState(
      ...
      async () => {
        console.log(this.state.status); // Giá trị cập nhật chính xác
        await this.callApi();
      }
    );
  }
        ...
        <div className="main_container">
          ...
          <div className="content">
            ...
            <Row>
              ...
              <Col span={4} offset={4}>
                <Button onClick={this.handleClickOrder.bind(this)}>
